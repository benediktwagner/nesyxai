...
class ConvNet(object):
    def __init__(self, img_rows, img_cols, channels, n_classes, optimizer=Adam,
    ...
    def build_model(self):
        ...
        if tf.keras.backend.image_data_format() == 'channels_last':
            latent = Reshape((self.img_rows, self.img_cols, 3))(input_layer)
        else:
            latent = Reshape((3, self.img_rows, self.img_cols))(input_layer)
