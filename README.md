...
This PyTorch adaptation follows the main [Tensorflow LTN implementation](https://github.com/logictensornetworks/logictensornetworks). 
This implementation, however, is fully translated into the PyTorch framework with additional functionality (such as simple integration of different types of existing models and linear probing of layers for grounding abstract representations). 
